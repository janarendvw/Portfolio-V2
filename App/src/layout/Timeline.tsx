...
export default function Timeline({}: Props) {
  return (
    <div id="timeline" className="w-full flex items-center justify-between">
      ...
      <div id="timeline-track" className="w-full h-1 bg-secondary/20 flex items-center overflow-hidden rounded-box"><span id="timeline-thumb" className="rounded-box block w-8 h-1 bg-secondary relative"></span></div>
